...
# Batch 21 of the c-testsuite (github.com/c-testsuite/c-testsuite)
    ...
    "steps": [
        {
            ...
            "description": "upstream c-testsuite tests/single-exec/00214.c [portable, c89] -- /* Check some way in where code suppression caused various",
            "param": {
                "name": "nova1",
                "script_path": "{projbasedir}{projdir}/gen/ct00214.ini",
        ...
        },
        {
            ...
            "description": "Check ct00214 printed \"00214: PASS\" to its console",
            "param": {
                "name": "nova1",
                "successphrase": "PASS",
                "failphrase": "FAIL",
        ...
        {
            "action": "test_startnovasimh",
            "description": "upstream c-testsuite tests/single-exec/00215.c [portable, c99] -- extern int printf(const char *format, ...);",
            "param": {
                "name": "nova2",
                "script_path": "{projbasedir}{projdir}/gen/ct00215.ini",
                "cwd": "{projbasedir}{projdir}",
                "boot_rdos": False
            },
            "subaction": ""
        ...
        {
            "action": "test_novascreensearch",
            "description": "Check ct00215 printed \"00215: PASS\" to its console",
            "param": {
                "name": "nova2",
                "successphrase": "PASS",
                "failphrase": "FAIL",
        ...
        {
            "action": "test_startnovasimh",
            "description": "upstream c-testsuite tests/single-exec/00217.c [portable, c89] -- int printf(const char *, ...);",
            "param": {
                "name": "nova3",
                "script_path": "{projbasedir}{projdir}/gen/ct00217.ini",
                "cwd": "{projbasedir}{projdir}",
                "boot_rdos": False
            },
            "subaction": ""
        ...
        {
            "action": "test_novascreensearch",
            "description": "Check ct00217 printed \"00217: PASS\" to its console",
            "param": {
                "name": "nova3",
                "successphrase": "PASS",
                "failphrase": "FAIL",
        ...
        {
            "action": "test_startnovasimh",
            "description": "upstream c-testsuite tests/single-exec/00218.c [portable, c89] -- /* This checks if enums needing 8 bit but only having positive",
            "param": {
                "name": "nova4",
                "script_path": "{projbasedir}{projdir}/gen/ct00218.ini",
                "cwd": "{projbasedir}{projdir}",
                "boot_rdos": False
            },
            "subaction": ""
        ...
        {
            "action": "test_novascreensearch",
            "description": "Check ct00218 printed \"00218: PASS\" to its console",
            "param": {
                "name": "nova4",
                "successphrase": "PASS",
                "failphrase": "FAIL",
        ...
        {
            "action": "test_startnovasimh",
            "description": "upstream c-testsuite tests/single-exec/00219.c [portable, c89, needs-libc, needs-cpp] -- #include <stdio.h>",
            "param": {
                "name": "nova5",
                "script_path": "{projbasedir}{projdir}/gen/ct00219.ini",
                "cwd": "{projbasedir}{projdir}",
                "boot_rdos": False
            },
            "subaction": ""
        ...
        {
            "action": "test_novascreensearch",
            "description": "Check ct00219 printed \"00219: PASS\" to its console",
            "param": {
                "name": "nova5",
                "successphrase": "PASS",
                "failphrase": "FAIL",
        ...
        {
            "action": "test_startnovasimh",
            "description": "upstream c-testsuite tests/single-exec/00220.c [portable, c99, needs-libc, needs-cpp] -- // this file contains BMP chars encoded in UTF-8",
            "param": {
                "name": "nova6",
                "script_path": "{projbasedir}{projdir}/gen/ct00220.ini",
                "cwd": "{projbasedir}{projdir}",
                "boot_rdos": False
            },
            "subaction": ""
        ...
        {
            "action": "test_novascreensearch",
            "description": "Check ct00220 printed \"00220: PASS\" to its console",
            "param": {
                "name": "nova6",
                "successphrase": "PASS",
                "failphrase": "FAIL",
        ...
        {
            "action": "test_startnovasimh",
            "description": "hand-written toolchain smoke test (testmain() returning 0)",
            "param": {
                "name": "nova7",
